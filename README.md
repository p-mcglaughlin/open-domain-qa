...
See the wiki for a more detailed explaination of [keyword matching](wiki/TF-IDF_BM25.md) and [vector embeddings](wiki/Embeddings.md) approaches. The [approximate nearest neighbors](wiki/Approximate-Nearest-Neighbors) page outlines finding nearest neighbors in high dimensional spaces required for embedding based methods. For a comparison of QA system performance see [Performance and Benchmarks](#performance-and-benchmarks).
